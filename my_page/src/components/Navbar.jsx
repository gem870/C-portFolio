...
{/* Destop Nav */}
    <div className="hidden md:block mx-20 pt-2 bg-[#000300] bg-opacity-80">
      <ul className="flex  text-gray-400 items-center justify-center py-2 border-b shadow-custom border-b-gray-800">
        <li className="px-5 text-[18px] hover:text-[#fa2d5d] hover:shadow-custom transition-shadow duration-300">About</li>
        <li className="px-5 text-[18px] hover:text-[#fa2d5d] hover:shadow-custom transition-shadow duration-300">Projects</li>
        <li className="px-5 text-[18px] hover:text-[#fa2d5d] hover:shadow-custom transition-shadow duration-300">Blogs</li>
...
{/* Phone Nav */}
    <div className={!nav ? "block mx-3  ease-in duration-500 md:hidden bg-[#000300] bg-opacity-80" : "fixed left-[-100%] ease-out duration-1000"}>
      <ul className="  text-gray-400 items-center justify-center py-2 border-b border-b-gray-800">
        ...
        <li className="px-5 py-1 text-[15px] hover:text-[#fa2d5d] hover:shadow-custom transition-shadow duration-300">Blogs</li>
